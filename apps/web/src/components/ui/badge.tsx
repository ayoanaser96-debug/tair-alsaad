  ...
  "inline-flex items-center gap-1 rounded-full border font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        warning: "border-transparent bg-amber-600/15 text-amber-900 dark:text-amber-100",
        danger: "border-transparent bg-red-600/15 text-red-800 dark:text-red-200",
        destructive: "border-transparent bg-destructive text-destructive-foreground hover:bg-destructive/80",
        info: "border-transparent bg-blue-600/15 text-blue-900 dark:text-blue-200",
